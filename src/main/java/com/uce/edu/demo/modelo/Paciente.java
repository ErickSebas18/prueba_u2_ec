...
public class Paciente {
	...
	@Column(name = "paci_codigo_iees")
	private String codigoIees;
	@Column(name = "paci_id_estatura")
	private Double estatura;
	@Column(name = "paci_id_peso")
	private Double peso;
	@Column(name = "paci_id_genero")
	...
	public String toString() {
		return "Paciente [id=" + id + ", cedula=" + cedula + ", nombre=" + nombre + ", apellido=" + apellido
				+ ", fechaNacimiento=" + fechaNacimiento + ", codigoIees=" + codigoIees + ", estatura=" + estatura
